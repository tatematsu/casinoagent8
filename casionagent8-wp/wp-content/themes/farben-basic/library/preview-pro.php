...
class Bavotasan_Preview_Pro {
	private $theme_url = 'http://themes.bavotasan.com/themes/farben/';
	...
	public function bavotasan_preview_pro() {
		...
		<div class="wrap about-wrap" id="custom-background">
			...
			<div class="changelog headline-feature dfw">
				...
				<p><?php _e( 'Establish your online presense by letting your visitors join your social network. Help them stay up to date on everything you&rsquo;re doing', 'farben' ); ?></p>
