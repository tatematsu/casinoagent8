					...
					if ( $comments ) {
						foreach ( $comments as $comment ) { ?>
							...
							<li>
								...
								<a href="<?php echo get_permalink($comment->comment_post_ID); ?>#comment-<?php echo $comment->comment_ID; ?>" title="<?php _e('Comment to','garfunkel'); echo ' ' . get_the_title($comment->comment_post_ID) . ', '; _e('posted','garfunkel'); echo ' ' . get_the_time(get_option('date_format')); ?>">
