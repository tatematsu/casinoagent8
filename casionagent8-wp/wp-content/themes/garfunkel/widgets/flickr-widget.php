...
// Flickr widget for garfunkel WordPress theme

class garfunkel_flickr_widget extends WP_Widget {

	function garfunkel_flickr_widget() {
		parent::WP_Widget(false, $name = 'Flickr widget', array('description' => __('Displays your latest Flickr photos.', 'garfunkel') ));	
	}
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo $this->get_field_id('id'); ?>"><?php _e('Flickr ID (use <a target="_blank" href="http://www.idgettr.com">idGettr</a>):', 'garfunkel'); ?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('number'); ?>"><?php _e('Number of images to display:', 'garfunkel'); ?>
...
register_widget('garfunkel_flickr_widget'); ?>